...
| [`implementing`](./implementing/SKILL.md) | `/implementing "specs/<feature-name>.md"` | **Non-interactive** sandbox: branch `feat/<feature-name>`, TDD loop, `cd react && yarn test`, PR with named sections. On block: opens a GitHub issue and ends. |
